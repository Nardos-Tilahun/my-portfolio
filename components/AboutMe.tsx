  ...
  return (
    ...
    >
      <div className="container px-4 md:px-6 py-4 md:py-0">
        ...
        <div className="max-w-4xl mx-auto space-y-6 p-6 bg-gray-900/70 backdrop-blur-md rounded-lg shadow-lg animate-fade-in-up">
          <p className="text-lg leading-relaxed">
            Hi! I&apos;m a dedicated <span className="text-indigo-400">Full Stack Developer</span> and a{" "}
            <span className="text-green-400">Master&rsquo;s student in Computer Science at HiLcoE</span>, with a background that bridges technology and engineering. I spent <span className="text-purple-400">five years</span> as a civil engineer, working as a contractor and structural designer, where I developed software solutions for challenges in construction and design.
          </p>
          <p className="text-lg leading-relaxed">
            Over the past <span className="text-purple-400">two years</span>, I&rsquo;ve expanded my expertise in web development, using frameworks like <span className="text-pink-400">React</span>, <span className="text-indigo-400">Next.js</span>, and <span className="text-yellow-400">Node.js</span>. I thrive on solving challenging problems through agile methodologies and building scalable, user-centric applications.
          </p>
          <p className="text-lg leading-relaxed">
          ...
          <p className="text-lg leading-relaxed">
            ...
            simplify lives. Let&rsquo;s build something remarkable together!
          </p>
        </div>
      </div>
